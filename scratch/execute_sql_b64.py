...
$cmd.CommandText = $sql
$cmd.ExecuteNonQuery()
Write-Host "ALTER PROCEDURE succeeded with exact UTF-8 Unicode!"

$conn.Close()
'''

with open(r"d:\SVN\crm\scratch\run_fix_sp_b64.ps1", "w", encoding="utf-8-sig") as f:
    f.write(ps1_content)

print("Created run_fix_sp_b64.ps1 successfully!")
