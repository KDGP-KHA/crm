...
VALUES
    ...
    ('DigitalSales_Entity_Name', N'Hồ sơ kinh doanh SPDV Số'),
    ('DigitalSales_NewRecord_Help', N'Hồ sơ mới mặc định thuộc loại hình <strong>Cơ hội kinh doanh</strong> với trạng thái <strong>Chưa nắm bắt</strong>. Sau khi tiếp cận khách hàng và có thông tin SPDV số, có thể chuyển đổi thành <strong>Dự án</strong>.'),
    ('DigitalSales_SelectCustomer_Button', N'Chọn khách hàng'),
    ('DigitalSales_ClearCustomer_Title', N'Bỏ chọn'),
    ('DigitalSales_CurrentFiles_Label', N'Các tệp đã đính kèm hiện tại:'),
    ('DigitalSales_RemoveFile_Title', N'Xóa file'),
    ('DigitalSales_MultipleFiles_Help', N'Có thể chọn cùng lúc <strong>nhiều file</strong> bằng phím <code>Ctrl</code> hoặc <code>Shift</code>.'),
    ('DigitalSales_CustomerLookup_Title', N'Tra cứu và chọn khách hàng / doanh nghiệp'),
    ('DigitalSales_CustomerLookup_Customer', N'Khách hàng / Doanh nghiệp'),
    ('DigitalSales_CustomerLookup_TaxCode', N'Mã số thuế'),
    ('DigitalSales_CustomerLookup_Phone', N'Số điện thoại'),
    ('DigitalSales_CustomerLookup_Address', N'Địa chỉ'),
    ('DigitalSales_CustomerLookup_Loading', N'Đang tải danh sách khách hàng...'),
    ('DigitalSales_CustomerLookup_Searching', N'Đang tìm kiếm...'),
    ('DigitalSales_CustomerLookup_NoResult', N'Không tìm thấy khách hàng nào phù hợp với từ khóa!'),
    ('DigitalSales_CustomerLookup_ZeroResult', N'Hiển thị 0 kết quả'),
    ('DigitalSales_CustomerLookup_ResultFormat', N'Hiển thị {0} / {1} khách hàng (Trang {2}/{3})'),
    ('DigitalSales_Msg_ConnectionError', N'Có lỗi xảy ra khi kết nối máy chủ!'),
    ('DigitalSales_Record_Label', N'Hồ sơ'),
    ('DigitalSales_CurrentStatus_Label', N'Trạng thái hiện tại'),
    ('DigitalSales_NewStatus_Option', N'-- Chọn trạng thái mới --'),
    ('DigitalSales_ChangeStatus_Title', N'Chuyển trạng thái hồ sơ kinh doanh số'),
    ('DigitalSales_ChangeStatus_Confirm_Button', N'Xác nhận chuyển'),
    ('DigitalSales_ChangeStatus_ProjectRequirement', N'Lưu ý: khi chuyển sang dự án, hồ sơ phải có ít nhất một sản phẩm / dịch vụ số và một thành viên tham gia.'),
    ('DigitalSales_ChangeStatusAttachment_Help', N'Đính kèm file minh chứng cho việc chuyển trạng thái nếu có.'),
    ('DigitalSales_ChangeStatusNote_Help', N'Nội dung được ghi vào dòng thời gian của hồ sơ.'),
    ('DigitalSalesProduct_Add_Title', N'Thêm mới sản phẩm / dịch vụ số'),
    ('DigitalSalesProduct_Edit_Title', N'Cập nhật sản phẩm / dịch vụ số'),
    ('DigitalSalesProduct_Save_Button', N'Lưu sản phẩm'),
    ('DigitalSalesProduct_Note_Placeholder', N'Ghi chú điều kiện triển khai, quy mô người dùng hoặc thỏa thuận gói cước...'),
    ('DigitalSalesMember_CustomRole_Label', N'Vai trò khác'),
    ('DigitalSalesMember_Add_Title', N'Thêm nhân sự tham gia'),
    ('DigitalSalesMember_Employees_Section', N'Thành viên tham gia'),
    ...
    ('DigitalSalesTracking_Save_Button', N'Lưu tiến trình'),
    ('DigitalSalesTracking_Status_NotStarted', N'1. Chưa thực hiện'),
    ('DigitalSalesTracking_Status_InProgress', N'2. Đang thực hiện'),
    ('DigitalSalesTracking_Status_Completed', N'3. Đã hoàn thành'),
    ('DigitalSalesTracking_Status_Overdue', N'4. Quá hạn / Tạm dừng'),
    ('DigitalSalesTracking_CurrentFile_Link', N'Tải file hiện tại'),
    ('DigitalSales_Msg_CustomerRequired', N'Vui lòng chọn khách hàng!'),
    ('DigitalSales_Msg_TitleRequired', N'Vui lòng nhập tên cơ hội / dự án!'),
    ('DigitalSales_Msg_AMRequired', N'Vui lòng chọn nhân sự phụ trách / AM chủ trì!'),
    ('DigitalSales_Msg_InvalidData', N'Dữ liệu không hợp lệ!'),
    ('DigitalSales_Msg_InvalidSalesRecord', N'Hồ sơ không hợp lệ!'),
    ('DigitalSales_Msg_ProductRequired', N'Vui lòng chọn sản phẩm / dịch vụ số!'),
    ('DigitalSales_Msg_MemberRequired', N'Vui lòng chọn ít nhất một nhân sự tham gia!'),
    ('DigitalSales_Msg_TaskNameRequired', N'Vui lòng nhập tên công việc / tiến trình!'),
    ...
    ('Button_Cancel', N'Hủy'),
    ('Button_Close', N'Đóng'),
    ('Button_Search', N'Tìm kiếm'),
    ('Button_Select', N'Chọn'),
    ('Table_Index', N'STT'),
    ('Common_Loading', N'Đang tải...'),
    ('DigitalSalesTracking_TaskName_Label', N'Tên công việc'),
    ('DigitalSalesTracking_AssignedUser_Label', N'Người thực hiện'),
    ('DigitalSalesTracking_StartDate_Label', N'Ngày bắt đầu'),
    ('DigitalSalesTracking_Deadline_Label', N'Hạn xử lý (Deadline)'),
    ('DigitalSalesTracking_Status_Label', N'Trạng thái'),
    ('DigitalSalesTracking_ResultNote_Label', N'Kết quả thực hiện'),
    ('DigitalSalesTracking_AttachmentFile_Label', N'Tệp đính kèm'),
    ('DigitalSalesTracking_ParentTask_Label', N'Tiến trình cha'),
    ('DigitalSalesTracking_DurationDays_Label', N'Tổng ngày thực hiện'),
    ('DigitalSalesTracking_MaxDeadline_Label', N'Hạn chót tối đa'),
    ('DigitalSalesTracking_DeadlineExceeded_Error', N'Hạn xử lý của công việc không được lớn hơn Ngày bắt đầu + Tổng ngày thực hiện của tiến trình.'),
    ('DigitalSalesTracking_ChangeProcess_Title', N'Cập nhật Quy trình thực hiện'),
    ('DigitalSalesTracking_SelectProcess_Label', N'Chọn quy trình mới áp dụng'),
    ('DigitalSalesTracking_AddTodo_Title', N'Thêm công việc con vào tiến trình'),
    ('DigitalSalesTracking_EditTodo_Title', N'Chỉnh sửa công việc con'),
    ('DigitalSalesTracking_Report_Title', N'Báo cáo tiến độ thực hiện'),
    ('DigitalSalesTracking_Confirm_Title', N'Xác nhận hoàn thành'),
    ('DigitalSalesTracking_Unlock_Title', N'Mở khóa xác nhận'),
    ('DigitalSalesTracking_Process_Label', N'Quy trình'),
    ('DigitalSalesTracking_Progress_Label', N'Tiến trình'),
    ('DigitalSalesTracking_ConfirmSuccess', N'Xác nhận hoàn thành thành công!'),
    ('DigitalSalesTracking_UnlockSuccess', N'Mở khóa xác nhận thành công!'),
    ('DigitalSalesTracking_ReportSuccess', N'Cập nhật báo cáo tiến độ thành công!'),
    ('DigitalSalesTracking_SaveSuccess', N'Lưu công việc thành công!'),
    ('DigitalSalesTracking_DeleteSuccess', N'Xóa công việc thành công!'),
    ('DigitalSalesTracking_ChangeProcessSuccess', N'Cập nhật quy trình thành công!');
